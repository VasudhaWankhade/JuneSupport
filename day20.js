...
//     }
// }
// let vasudha = new Bank("Vasudha Wankhade", 2000)
// console.log(vasudha)
// vasudha.deposit(2000)
// console.log(vasudha)
// vasudha.deposit(2000)
// console.log(vasudha)
// vasudha.withdrawal(3000)
// console.log(vasudha)
// vasudha.withdrawal(500)
// vasudha.deposit(1500)
// console.log(vasudha)
// vasudha.deposit(5000)
// vasudha.withdrawal(2000)
// console.log(vasudha)
// let last5 = vasudha.last5Transactions()
// console.log(last5)
...
class Bank {
    ...
    deposit(amount) {
        if (amount > 0) {
            this.transactions.push(amount)
            this.balance = this.balance + amount // 5000  + 2000 == 7000
        }
    }
    ...
    withdrawal(amount) {
        if (amount < this.balance) {
            this.transactions.push(-amount)
            this.balance = this.balance - amount // 7000 - 3000 =4000
        } else {
            console.log("Insufficient balance")
        }
    }
...
let vasudha = new Bank("Vasudha Wankhade", 5000)
console.log(vasudha)
...
vasudha.withdrawal(5000)
vasudha.deposit(5000)
vasudha.withdrawal(2000)
vasudha.deposit(10000)
vasudha.withdrawal(3000)

console.log(vasudha)

let last5 = vasudha.last5Transaction()
console.log(last5)
